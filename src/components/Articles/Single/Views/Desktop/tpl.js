            ...
            <div className={ Styles.containerContent }>
                ...
                <div className={ Styles.content }>
                    <p className={ Styles.paragraph }>
                        ...
                        эфир на спутник Astra 4A (Sirius). Как изменилась «Надія» за это временя? временя?
                        временя?
                    </p>
                    ...
                    <p className={ Styles.paragraph }>
                        Ретрансляция спутникового сигнала осуществляется в Интернете, эфирных станциях и кабельных
                        сетях.За эти 2 года телеканал
                        <a href="#">&nbsp;«Надія»&nbsp;</a>
                        заключил договоры с 130 кабельными операторами по всей
                        Украине  (в том числе с такими масштабными провайдерами, как «Воля-кабель»,
                        «Триолан», «Датагруп»).
                    </p>
                </div>
            </div>
