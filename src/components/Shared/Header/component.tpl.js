...
import SvgWorTopFb from 'components/Shared/Header/Assets/topFb.svg';
import SvgWorTopTwitter from 'components/Shared/Header/Assets/topTwitter.svg';
import SvgWorTopVk from 'components/Shared/Header/Assets/topVk.svg';
import SvgWorTopYoutube from 'components/Shared/Header/Assets/topYoutube.svg';
                ...
                { [
                    ...
                    <div>
                        <header>
                            ...
                            <div className={ Styles.social }>
                                <a href="#" className={ Styles.youtube }>
                                    <InlineSvg content={ SvgWorTopYoutube }/>
                                </a>
                                <a href="#" className={ Styles.twitter }>
                                    <InlineSvg content={ SvgWorTopTwitter }/>
                                </a>
                                <a href="#"className={ Styles.vk } >
                                    <InlineSvg content={ SvgWorTopVk }/>
                                </a>
                                <a href="#" className={ Styles.fb }>
                                    <InlineSvg content={ SvgWorTopFb }/>
                                </a>
                            </div>
                        </header>
                        <div className={ Styles.wrap }>
