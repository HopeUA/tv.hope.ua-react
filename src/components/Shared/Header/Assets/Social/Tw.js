...
export default class Tw extends Component {
    ...
    render() {
        ...
        return (
            <path
                fill={ colorFill } d="M200,19.2c-7.4,3.3-15.3,5.5-23.6,6.4c8.5-5.1,15-13.1,18-22.6c-7.9,4.7-16.7,
                8.1-26.1,9.9C160.9,5,150.3,0,138.5,0c-22.7,0-41,18.3-41,40.9c0,3.2,0.4,6.3,1.1,
